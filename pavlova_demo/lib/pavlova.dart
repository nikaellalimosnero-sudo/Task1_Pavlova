...
class Pavlova extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Limosnero_Activity 1')),
      body: Column(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Pavlova is a merengui-based dessert named afte the Russian ballerina Anna Pavlova,"
                  "Pavloca features a crisp crust and soft, light inside, topped with fruit and whipped cream.",
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.black,
                    height: 1.5,
